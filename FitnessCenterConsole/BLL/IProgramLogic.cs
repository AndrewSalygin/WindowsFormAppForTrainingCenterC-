...
namespace FitnessCenterConsole.BLL
{
    public interface IProgramLogic {
        ...
        bool AddNewClient(string surname, string name, string middleName, DateTime birthday, 
            string phoneNumber);
        ...
        bool AddNewTraining(int gymKey, string surnameCoach, string phoneNumberCoach, HashSet<string> clientKeys,
            DateTime dateTime);

        bool AddNewTraining(int gymKey, string surnameCoach, string phoneNumberCoach, DateTime dateTime);
        bool AddNewTraining(int gymKey, DateTime dateTime);
