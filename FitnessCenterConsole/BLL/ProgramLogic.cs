...
namespace FitnessCenterConsole.BLL
{
    public class ProgramLogic : IProgramLogic {
        ...
        public bool AddClientToTraining(string surnameClient, string phoneNumberClient,
            ...
            return Database.AddClientToTraining(surnameClient, phoneNumberClient, numberOfGym,
                dateTime);
        }
        ...
        public bool DeleteClientFromTraining(string surnameClient, string phoneNumberClient,
            int numberOfGym, DateTime dateTime) {
            return Database.DeleteClientFromTraining(surnameClient, phoneNumberClient, numberOfGym, dateTime);
        }
        ...
        public string FindCoachesByPhone(string phone) {
            return Database.FindCoachesByPhone(phone);
        }
        ...
        public string FindClientsByPhone(string phone) {
            return Database.FindClientsByPhone(phone);
        }
        ...
        public string GetAllCoaches() {
            return Database.GetAllCoaches();
        }

        public string GetAllGyms() {
            return Database.GetAllGyms();
        }
